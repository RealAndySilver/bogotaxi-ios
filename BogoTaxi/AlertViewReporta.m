...
@implementation AlertViewReporta
@synthesize labelMensaje,buttonSi,buttonNo;
...
-(void)crearView{
    ...
    buttonSi.center=CGPointMake((contentView.frame.size.width/2)/2, labelMensaje.frame.size.height+40);
    ...
    buttonNo.center=CGPointMake((contentView.frame.size.width/2)+((contentView.frame.size.width/2)/2), labelMensaje.frame.size.height+40);
